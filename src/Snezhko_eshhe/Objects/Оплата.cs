...
namespace IIS.Snezhko_eshhe
{
    ...
    [View("ОплатаE", new string[] {
            ...
            "Запись.Клиент.Фамилия as \'Фамилия клиента\'",
            "Запись.Сотрудники.Фамилия as \'Фамилия сотрудника\'"}, Hidden=new string[] {
            "Запись.Время"})]
    ...
    [View("ОплатаL", new string[] {
            ...
            "ТипОплаты as \'Тип оплаты\'",
            "Запись.Время as \'Время\'",
            "Запись.Клиент.Фамилия as \'Фамилия сотрудника\'",
            "Запись.Сотрудники.Фамилия as \'Фамилия клиента\'"})]
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        
        private bool fОплачено;
        
        private IIS.Snezhko_eshhe.ТипОплат fТипОплаты;
        ...
        public virtual IIS.Snezhko_eshhe.ТипОплат ТипОплаты
        {
            get
            {
                ...
                IIS.Snezhko_eshhe.ТипОплат result = this.fТипОплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Snezhko_eshhe.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Snezhko_eshhe.Оплата));
                }
            }
        }
    }
