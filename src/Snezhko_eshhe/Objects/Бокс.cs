    ...
    public class Бокс : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БоксE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БоксE", typeof(IIS.Snezhko_eshhe.Бокс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View БоксL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БоксL", typeof(IIS.Snezhko_eshhe.Бокс));
                }
            }
        }
    }
